        ...
        set ::env(USER_ROOT)    "/home/dinesha/workarea/opencore/git/logic_bist"
	...
	## User Project Spef
        ...
        read_spef -path mprj/u_mbist5                       $::env(USER_ROOT)/spef/mbist_top2.spef  
        read_spef -path mprj/u_mbist6                       $::env(USER_ROOT)/spef/mbist_top2.spef  
        read_spef -path mprj/u_mbist7                       $::env(USER_ROOT)/spef/mbist_top2.spef  
        read_spef -path mprj/u_mbist8                       $::env(USER_ROOT)/spef/mbist_top2.spef  
        ...
        read_spef -path mprj/u_glbl                         $::env(USER_ROOT)/spef/glbl_cfg.spef
